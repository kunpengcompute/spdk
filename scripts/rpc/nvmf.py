...
def nvmf_set_req_timeout(client):
    """Set current running req timeout.
    ...
    Returns:
        None
    """
    return client.call('nvmf_set_req_timeout')

def nvmf_set_req_timeout_10s(client):
    """Set current running req timeout 10s then cache invalid.
    ...
    Returns:
        None
    """
    return client.call('nvmf_set_req_timeout_10s')

def nvmf_set_ocf_cache_invalid(client):
    """Set current ocf status invalid
    ...
    Returns:
        None
    """
    return client.call('nvmf_set_ocf_cache_invalid')

def nvmf_set_io_timeout_threshold(client, time):
    """Set io timeout time

    Args:
        time out threshold: timeout in second
...
def nvmf_set_cache_fault_time_threshold(client, time):
    ...
    return client.call('nvmf_set_cache_fault_time_threshold', params)

def nvmf_set_cache_fault_io_threshold(client, number):
    """Set cache fault io number

    Args:
        number: cache fault when io number exceed the threshold
